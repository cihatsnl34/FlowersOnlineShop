...
@section('content')
        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Çiçek Ekle <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted">
                        sisteme yeni çiçek eklemek için kullanılıyor </small>
                </h1>
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">Çiçek Ekle</li>
    ...
    <div class="row justify-content-center">
        ...
        <div class="js-wizard-simple block block col-md-6">
            ...
            <!-- Form -->
            <form action="{{ route('admin.flower_add') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Steps Content -->
                <div class="block-content block-content-full tab-content px-md-5" style="min-height: 314px;">
                    ...
                    <div class="tab-pane" id="wizard-progress2-step2" role="tabpanel">
                        ...
                        <div class="form-group">
                            <label for="wizard-progress2-Alt">Alt Resimler</label>
                            <input class="form-control form-control-alt" multiple type="file" id="wizard-progress2-Alt"
                                name="resimUrl[]">
                        </div>
