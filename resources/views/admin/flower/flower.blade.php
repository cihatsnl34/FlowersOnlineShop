                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 15%;">Stok Miktar</th>
                            <th style="width: 10%;">Yüklenme Tarihi</th>
                    ...
                    <tbody>
                        @foreach ($flowers as $rs)
                            <tr>
                                ...
                                <td class="text-center font-size-sm">{{ $rs->created_at }}</td>
                                <td>
                                    <a class="inline-block mr-2" href="{{ route('admin.flower_edit', ['id' => $rs->id]) }}">
                                    ...
                                    <a class="inline-block" href="{{ route('admin.flower_delete', ['id' => $rs->id]) }}"
